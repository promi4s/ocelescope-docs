...
The only dependency is Docker, which we'll get to in the first step. A video walkthrough of these steps is included below.
...
The following video shows how to walk through these steps.

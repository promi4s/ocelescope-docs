...
Once your plugin ZIP is built and published as a GitHub release, see [Submit a Plugin](/community/submit-plugin/) for how to add it to the public plugin catalog.
